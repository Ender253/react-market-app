...
const AvailableProducts = (props) => {
  const {categories, categoryId,category, filterCategories} = useCategoriesQuery();
  ...
  const isInCategories = useCallback(
    (categoryId, productCategoryId) => {
      ...
      return (
        isSubcategory(category, productCategory)
      );
    },
  ...
  const filterProducts = useCallback(
    (product) => {
      ...
      return isInCategories(categoryId, product.categoryId);
    },
    [categoryId, isInCategories]
  );
