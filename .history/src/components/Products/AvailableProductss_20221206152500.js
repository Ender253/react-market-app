...
const AvailableProducts = (props) => {
  ...
  const { productss,product , status, error } = useProductQuery();
const dispatch = useDispatch();
console.log('a',productss,'b',product)
const  setProdctEl = useCallback(
  ...
  const productList = Object.values(productss)?.filter(filterProducts).map((product) => {
